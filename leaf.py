...
filepath = '/Users/rabby/Desktop/Leaf-Disease/model.h5'
...
def pred_tomato_dieas(tomato_plant):
    ...
    print(pred)
    if pred == 0:
        return "Tomato - Tomato Bacterial", 'Tomato-Bacteria Spot.html'
...
def predict():
    if request.method == 'POST':
        ...
        file_path = os.path.join(
            '/Users/rabby/Desktop/Leaf-Disease/static/upload/', filename)
        file.save(file_path)
